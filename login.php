...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select ID, FirstName from tbluser where  (Email='$emailcon' || MobileNumber='$emailcon') && Password='$password' ");
    $ret=mysqli_fetch_array($query);
    if($ret>0){
      $_SESSION['bpmsuid']=$ret['ID'];
      $_SESSION['bpmsname']=$ret['FirstName'];
...
<html lang="en">
  <head>
    ...
    <title>Online Beauty Heaven| Login</title>
                ...
                <div class="map-content-9 mt-lg-0 mt-4">
                    <form method="post">
                        ...
                        <div class="twice-two" style="padding-top: 30px;">
                          ...
                          <a class="link--gray" style="color: blue;" href="signup.php">new users?</a>
