...
<html lang="en">
<head>
    <title>Online Beauty Heaven | Appointment Page</title>
    <!-- Template CSS -->
                    ...
                    <form method="post">
                        <div style="padding-top: 30px;">
                            ...
                            <select class="form-control" name="service" required>
                                ...
                                while ($serviceRow = mysqli_fetch_array($serviceQuery)) {
                                    echo '<option value="'.$serviceRow['ID'].'">'.$serviceRow['ServiceName'].'</option>';
                                }
                                ?>
                            </select>
                        </div>
                        ...
                        <div style="padding-top: 30px;">
                            ...
                            <select class="form-control" name="atime" id="atime" required>
                                ...
                                for ($hour = 10; $hour <= 19; $hour++) { // 19 is 7 PM in 24-hour format
