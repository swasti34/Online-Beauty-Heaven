...
{
echo "<script>alert('Invalid format. Only jpg / jpeg/ png ');</script>";
}
else
{
...
move_uploaded_file($_FILES["image"]["tmp_name"],"images/".$newimage);
    ...
    $query=mysqli_query($con, "insert into  tblservices(ServiceName,category,ServiceDescription,Cost,Image) value('$sername','$category','$serdesc','$cost','$newimage')");
    if ($query) {
...
<html>
<head>
<title>Onlien Beauty Heaven | Add Services</title>
