...
<html>
<head>
<title>Online Beauty Heaven|| Accepted Appointment</title>
...
<body class="cbp-spmenu-push">
    ...
    <div class="table-responsive bs-example widget-shadow">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php
                $ret = mysqli_query($con, "SELECT tbluser.FirstName, tbluser.LastName, tbluser.MobileNumber, tblbook.ID AS bid, tblbook.AptNumber, tblbook.AptDate, tblbook.AptTime, tblbook.Status FROM tblbook JOIN tbluser ON tbluser.ID = tblbook.UserID WHERE tblbook.Status = 'Selected'");
